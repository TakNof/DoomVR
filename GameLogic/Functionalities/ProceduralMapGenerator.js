import Matrix from '../Functionalities/Matrix.js';
...
class ProceduralMapGenerator{
    ...
    setWalls(amount){
        ...
        let functionsToCreateWalls = ["linealCreation", "radialCreation"];

        for(let a = 0; a < amount; a++){
            let index = this.#rand(0, functionsToCreateWalls.length - 1);
            let typeOfRoad = functionsToCreateWalls[index];
            this[typeOfRoad]();
        }
    }
...
export default ProceduralMapGenerator;